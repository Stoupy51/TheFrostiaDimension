...
execute store success score #success frostia.data run data modify entity @e[type=item,nbt={Item:{id:"minecraft:iron_ore"}},predicate=!frostia:has_tag,limit=1,sort=nearest,distance=..1] Item set from storage frostia:items all.christmas_present
