...
#Blocks
	...
	#Snowy Sapling
		data modify storage frostia:items all.snowy_sapling set value {Slot:16b		,id:"minecraft:furnace"						,Count:1b,tag:{ctc:{id:"snowy_sapling",from:"spr:frostia",traits:{"block":1b}}						,CustomModelData:2019001,frostia:{snowy_sapling:1b}						,display:{Lore:['{"translate":"Frostia","color":"blue","italic":true}']																																										,Name:'[{"text":"Snowy Sapling","italic":false}]'}										,BlockEntityTag:{Items:[{id:"minecraft:stone",Count:1b,Slot:0b,tag:{smithed:{block:{from:"frostia",id:"frostia:snowy_sapling"}}}}]}}}
