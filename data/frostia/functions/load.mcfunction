...
#Tools/Equipments
	...
	#Ice Staff
		data modify storage frostia:items all.ice_staff set value {Slot:16b,id:"minecraft:warped_fungus_on_a_stick"	,Count:1b,tag:{ctc:{id:"ice_staff",from:"spr:frostia",traits:{"tool":1b,"tool/weapon":1b}}			,CustomModelData:2019102,frostia:{ice_staff:1b}							,display:{Lore:['{"translate":"Frostia","color":"blue","italic":true}']																																										,Name:'[{"text":"Ice Staff","italic":false,"color":"blue"}]'}																																														,AttributeModifiers:[{AttributeName:"generic.attack_damage",Name:"generic.attack_damage",Slot:"mainhand",Amount:8,Operation:0,UUID:[I;201305,201305,201305,201305]},{AttributeName:"generic.attack_speed",Name:"generic.attack_speed",Slot:"mainhand",Amount:-2.25,Operation:0,UUID:[I;201305,201305,201305,201306]}]}}
