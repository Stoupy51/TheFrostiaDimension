...
scoreboard objectives add frostia.use_staff used:warped_fungus_on_a_stick
...
#Tools/Equipments
	#Christmas Socks
		data modify storage frostia:items all.christmas_socks set value {Slot:16b	,id:"minecraft:leather_boots"				,Count:1b,tag:{ctc:{id:"christmas_socks",from:"spr:frostia",traits:{"armor":1b}}					,CustomModelData:2019100,frostia:{christmas_socks:1b},HideFlags:64		,display:{Lore:['{"translate":"Frost Walker effect but on air block.","color":"gray","italic":false}','{"translate":"Enabled only when sprinting","color":"gray","italic":false}','{"translate":"Frostia","color":"blue","italic":true}']	,Name:'[{"text":"Christmas Socks","italic":false,"color":"red"}]',color:16711680} 		,AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Slot:"feet",Amount:4,Operation:0,UUID:[I;201304,201304,201304,201305]}	,{AttributeName:"generic.armor_toughness",Name:"generic.armor_toughness",Slot:"feet",Amount:2,Operation:0,UUID:[I;201304,201304,201305,201305]}]}}
	#Snow Globe
		data modify storage frostia:items all.snow_globe set value {Slot:16b		,id:"minecraft:warped_fungus_on_a_stick"	,Count:1b,tag:{ctc:{id:"snow_globe",from:"spr:frostia",traits:{"misc":1b}}							,CustomModelData:2019101,frostia:{snow_globe:1b}						,display:{Lore:['{"translate":"Invoke The Santa Claus","color":"gray","italic":false}','{"translate":"Frostia","color":"blue","italic":true}']																								,Name:'[{"text":"Snow Globe","italic":false,"color":"aqua"}]'}}}
	#Ice Staff
		data modify storage frostia:items all.ice_staff set value {Slot:16b			,id:"minecraft:warped_fungus_on_a_stick"	,Count:1b,tag:{ctc:{id:"ice_staff",from:"spr:frostia",traits:{"tool":1b,"tool/weapon":1b}}			,CustomModelData:2019102,frostia:{ice_staff:1b}							,display:{Lore:['{"translate":"Consume 16 ice blocks","color":"gray","italic":false}','{"translate":"Frostia","color":"blue","italic":true}']																								,Name:'[{"text":"Ice Staff","italic":false,"color":"aqua"}]'}							,AttributeModifiers:[{AttributeName:"generic.attack_damage",Name:"generic.attack_damage",Slot:"mainhand",Amount:4,Operation:0,UUID:[I;201305,201305,201305,201305]},{AttributeName:"generic.attack_speed",Name:"generic.attack_speed",Slot:"mainhand",Amount:-2.25,Operation:0,UUID:[I;201305,201305,201305,201306]}]}}
