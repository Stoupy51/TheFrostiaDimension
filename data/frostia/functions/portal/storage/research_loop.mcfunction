...
execute if score #compare_x frostia.data matches -8..8 if score #compare_y frostia.data matches -8..8 if score #compare_z frostia.data matches -8..8 run scoreboard players set #success frostia.data 1

execute if score #success frostia.data matches 1 run data modify storage frostia:temp teleport_pos set from storage frostia:temp copy[0]
