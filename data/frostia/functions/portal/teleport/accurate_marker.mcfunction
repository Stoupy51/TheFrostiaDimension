...
execute if score #dimension frostia.data matches 0 at @s in frostia:frostia run tp @p[tag=frostia.temp] ~1.5 ~-1 ~1.5
execute if score #dimension frostia.data matches 1 at @s in minecraft:overworld run tp @p[tag=frostia.temp] ~1.5 ~-1 ~1.5
