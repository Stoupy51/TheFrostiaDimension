...
execute if score .ice frostia.right_click matches 0 as @e[type=player,distance=..4,tag=!frostia.launcher,gamemode=!creative,gamemode=!spectator,tag=!frostia.no_ice] at @s run function frostia:staff/entity
