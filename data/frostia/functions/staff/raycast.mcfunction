...
execute if score .ice frostia.right_click matches 0 as @e[type=!#frostia:noai,type=!player,distance=..4,tag=!smithed.strict,tag=!global.ignore] at @s run function frostia:staff/entity
execute if score .ice frostia.right_click matches 0 as @e[type=player,distance=..4,tag=!frostia.launcher,gamemode=!creative,gamemode=!spectator] at @s run function frostia:staff/entity
