...
execute if score .ice frostia.use_staff matches 0 at @e[type=!#frostia:noai,type=!player,distance=..3,tag=!smithed.strict,tag=!global.ignore] run function frostia:staff/entity
execute if score .ice frostia.use_staff matches 0 at @e[type=player,distance=..3,tag=!frostia.launcher,gamemode=!creative,gamemode=!spectator] run function frostia:staff/entity
